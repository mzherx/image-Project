    ...
    <div
     ...
     bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
      ...
      <motion.form onSubmit={onSubmitHandler}
        ...
        className='relative bg-white p-[40px] rounded-xl text-slate-500'>
        <h1 className='text-center text-4xl text-neutral-700 font-medium mb-4'>{state}</h1>
        ...
        <div className='border px-10 py-3 flex items-center  gap-2 rounded-full mt-4'>
